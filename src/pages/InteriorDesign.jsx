                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative" data-aos="fade-left">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2 aspect-square flex flex-col items-center justify-center relative overflow-hidden">
                                    <div className="absolute bottom-0 left-0 w-full h-0 group-hover:h-full bg-gradient-to-br from-violet-500 to-purple-600 transition-all duration-500 ease-out z-0"></div>
                                    <div className="relative z-10 flex flex-col items-center">
                                        <div className="text-7xl mb-4 group-hover:scale-110 transition-transform">📐</div>
                                        <h3 className="font-bold text-lg mb-2 text-gray-900 group-hover:text-white transition-colors">3D Modeling</h3>
                                        <p className="text-sm text-gray-600 group-hover:text-violet-100 transition-colors">Photorealistic visuals</p>
                                    </div>
                                </div>

                                <div className="group bg-gradient-to-br from-violet-600 to-purple-600 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2 mt-4 sm:mt-8 aspect-square flex flex-col items-center justify-center relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center">
                                        <div className="text-7xl mb-4 group-hover:scale-110 transition-transform">🎨</div>
                                        <h3 className="font-bold text-lg mb-2 text-white group-hover:text-violet-900 transition-colors">Design</h3>
                                        <p className="text-sm text-violet-100 group-hover:text-violet-700 transition-colors">Expert styling</p>
                                    </div>
                                </div>

                                <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2 mt-4 sm:-mt-8 aspect-square flex flex-col items-center justify-center relative overflow-hidden">
                                    <div className="absolute bottom-0 left-0 w-full h-0 group-hover:h-full bg-gradient-to-br from-violet-500 to-purple-600 transition-all duration-500 ease-out z-0"></div>
                                    <div className="relative z-10 flex flex-col items-center">
                                        <div className="text-7xl mb-4 group-hover:scale-110 transition-transform">💡</div>
                                        <h3 className="font-bold text-lg mb-2 text-gray-900 group-hover:text-white transition-colors">Lighting</h3>
                                        <p className="text-sm text-gray-600 group-hover:text-violet-100 transition-colors">Smart solutions</p>
                                    </div>
                                </div>
                                ...
                                <div className="group bg-gradient-to-br from-violet-600 to-purple-600 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2 mt-4 sm:mt-8 aspect-square flex flex-col items-center justify-center relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center">
                                        <div className="text-7xl mb-4 group-hover:scale-110 transition-transform">🪑</div>
                                        <h3 className="font-bold text-lg mb-2 text-white group-hover:text-violet-900 transition-colors">Furniture</h3>
                                        <p className="text-sm text-white group-hover:text-violet-700 transition-colors">Custom pieces</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        {services.slice(1, 5).map((service, index) => (
                            <div
                                key={index}
                                className="group bg-white/80 backdrop-blur-sm border-2 border-violet-100 rounded-2xl p-8 hover:border-violet-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:border-transparent relative overflow-hidden"
                                data-aos="fade-up"
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="text-5xl mb-4 group-hover:scale-110 transition-transform group-hover:text-white">{service.icon}</div>
                                    <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-white transition-colors">{service.title}</h3>
                                    <p className="text-gray-600 mb-4 text-sm group-hover:text-violet-100 transition-colors">{service.description}</p>
                                    <ul className="space-y-2">
                                        {service.features.map((feature, idx) => (
                                            <li key={idx} className="flex items-center gap-2 text-xs text-gray-600 group-hover:text-violet-100 transition-colors">
                                                <svg className="w-3 h-3 text-violet-500 flex-shrink-0 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                </svg>
                                                {feature}
                                            </li>
