                ...
                <div className="grid md:grid-cols-4 gap-8 mb-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-3">
                            ...
                            {/* WhatsApp Icon */}
                            <a href="https://wa.me/6305790865" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-green-500/20 flex items-center justify-center hover:bg-green-500/30 transition-colors text-green-400">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
