...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white px-4 py-12 md:px-6">
            <div className="max-w-7xl mx-auto">
                {/* Main Footer Content */}
                <div className="grid md:grid-cols-4 gap-8 mb-6">
                    {/* Company Info */}
                    <div className="md:col-span-2">
                        <h3 className="text-2xl font-bold bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent mb-3">
                            VAS
                        </h3>
                        ...
                        <div className="flex gap-3">
                            ...
                            {/* WhatsApp Icon */}
                            <a href="https://wa.me/919000065111" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-green-500/20 flex items-center justify-center hover:bg-green-500/30 transition-colors text-green-400">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border-t border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
                    <p className="text-gray-400">&copy; {currentYear} VAS. All rights reserved.</p>
